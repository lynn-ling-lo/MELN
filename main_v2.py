...
def parse_args():
    ...
    parser.add_argument('--model', default='mermix', type=str)

    # process
    parser.add_argument('--train_path', default='/home/lynn/Dataset/CASME_extend/casme/Cropped/', type=str)
    parser.add_argument('--test_path', default='/home/lynn/Desktop/tmmocc/CASME_masked/', type=str)
    parser.add_argument('--label_path', default='/home/lynn/Dataset/CASME_extend/CASME.csv', type=str)
...
if __name__ == "__main__":
    ...
    for sub_v in sub_list:
        ...
        #train_data = casme_surgical_triplet_dataset(data_path = args.train_path, label_path = args.label_path, sub_v = sub_v, split='train',transform=transform)
        #train_data = samm_dataset(data_path = args.train_path, label_path = args.label_path, sub_v = sub_v, split='train')
        #train_data = casme_surgical_dataset(data_path = args.train_path, label_path = args.label_path, sub_v = sub_v, split='train')
        ...
        #test_data = casme_triplet_dataset(data_path = args.train_path, label_path = args.label_path, sub_v = sub_v, split='test',transform=transform)
        #test_data = casme_surgical_triplet_dataset(data_path = args.train_path, label_path = args.label_path, sub_v = sub_v, split='test',transform=transform)
        #test_data = casme_surgical_dataset(data_path = args.test_path, label_path = args.label_path, sub_v = sub_v, split='test',transform=transform)
